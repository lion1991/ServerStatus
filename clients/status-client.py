    ...
    while True:
        try:
            ...
            while True:
                ...
                array['ping_hd'] = lostRate.get('hd') * 100
                array['ping_ld'] = lostRate.get('ld') * 100
                array['ping_sz'] = lostRate.get('sz') * 100
                array['ping_tw'] = lostRate.get('tw') * 100
                array['time_hd'] = pingTime.get('hd')
                array['time_ld'] = pingTime.get('ld')
                array['time_sz'] = pingTime.get('sz')
                array['time_tw'] = pingTime.get('tw')
